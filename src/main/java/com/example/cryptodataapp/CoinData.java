...
public class CoinData {
    ...
    public void connectAndLoadData(){
        ...
        HttpRequest request = HttpRequest.newBuilder().uri(URI.create("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=15&sparkline=false&price_change_percentage=24h")).build();
    ...
    public static void parse(String responseBody){
        ...
        for(int i = 0; i<albums.length();i++){
            ...
            filledList.add(new Coin(id,symbol,name,imageFileSourcePath,currentPrice,marketCap,priceChange24h,priceChange24hPercentage,circulatingSupply,ath,athChangePercentage));
        }
